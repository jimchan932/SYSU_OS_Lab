...
public:
    ...
    // bitmap的起始地址
    char *bitmap;
    enum memoryType {OCCUPIED, UNALLOCATED, P1, P2, P3, P4};
    memoryType memoryTypeList[15984];
...
public:
    ...
    void firstFit(int processMemorySize[4]);
    int findBestFitAddress(int processMemorySize);
    void bestFit(int proessMemorySize[4]);
    void printMemory(memoryType type, int startAddress, int endAddress);
