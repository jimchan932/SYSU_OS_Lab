...
public:
    ...
    // 获取内存总容量
    int getTotalMemory();
    void printMemorySpace(enum AddressPoolType type);
    void firstFit(int processMemorySize[4], enum AddressPoolType type);
    void bestFit(int processMemorySize[4],enum AddressPoolType type);    
};
#endif
